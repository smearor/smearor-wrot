...
- **smearor-wrot-compositor-widget**: GTK4 widget for compositor rendering (depends on smearor-wrot-compositor)
...
- **Error Handling**: Integrate miette and thiserror (especially in smearor-wrot-compositor)
